package com.chiron.playpalyer.adapter;
...
import com.chiron.playpalyer.fragment.PlaybackFragment;
import com.chiron.playpalyer.recorder.RecordingItem;
...
public class FileViewerAdapter extends RecyclerView.Adapter<FileViewerAdapter.RecordingsViewHolder>{
    ...
    private LinkedHashMap<String,String> linkedHashMap = null;

    public FileViewerAdapter(Context context, LinearLayoutManager linearLayoutManager) {
        super();
        mContext = context;
        llm = linearLayoutManager;
        linkedHashMap = SharedPreferencesUtil.getInstance(context).getAllData();
    }
...
//                        }
    ...
    public RecordingItem getItem(int position) {
        ...
        for (Map.Entry<String, String> entry : linkedHashMap.entrySet()) {
            if (i == position) {
                Log.e("Item",entry.getKey()+"  "+entry.getValue());
                result = new RecordingItem(entry.getKey(), entry.getValue());
                break;
            }
            i++;
        }
